...
- Blatanty obvious vibe-coded games. If it looks vibe coded, it's probably vibe coded. You can use AI if you want, but if your whole game is vibe coded or your using AI generated content/assets, it won't be approved. There's a difference between vibe coding a whole game and using ai for coding sparingly. 
- AI generated assets. No ai images, music, sounds, text.
